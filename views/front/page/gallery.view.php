    ...
    <div class="container">
        ...
        <div class="col1 firstcol">
            ...
            <div id="carousel">
                ...
                <div>
                    <div class="puce-navigation"></div>
                </div>
                <button id="prev"><i class="fa fa-caret-left" aria-hidden="true"></i></button>
                <button id="play"><i id="pauseOrPlay" class="fa fa-play" aria-hidden="true"></i></button>
                <button id="next"><i class="fa fa-caret-right" aria-hidden="true"></i></button>
                <div id="rail"></div>
